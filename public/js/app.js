...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_index__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__router_router__ = __webpack_require__(39);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-58fb069a", Component.options)
  } else {
    hotAPI.reload("data-v-58fb069a", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-58fb069a", module.exports)
  }
}
...
var actions = {
    apiRequest: function apiRequest(_ref) {
        var state = _ref.state,
            commit = _ref.commit;

        axios.get("/oauth/clients", function (res) {
    ...
    login: function login(_ref2) {
        ...
        axios.post("/login", state.user).then(function (r) {
            console.log(r);
        });
    }
};
...
var routes = [{ path: "/login", component: __webpack_require__(41) }, { path: "/register", component: __webpack_require__(44) }, { path: "/", component: __webpack_require__(63) }];
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5400a5be", Component.options)
  } else {
    hotAPI.reload("data-v-5400a5be", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5400a5be", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-02a54c1b", Component.options)
  } else {
    hotAPI.reload("data-v-02a54c1b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        request: function request() {
            this.$store.dispatch("auth/apiRequest");
        }
    }
});
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("div", { staticClass: "col-md-6" }, [
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.register.fullName,
                          expression: "register.fullName"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.register.fullName },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.register.fullName = $event.target.value
                        }
                      }
                    })
                  ])
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("div", { staticClass: "col-md-6" }, [
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.register.emailAddress,
                          expression: "register.emailAddress"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.register.emailAddress },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.register.emailAddress = $event.target.value
                        }
                      }
                    })
                  ])
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("div", { staticClass: "col-md-6" }, [
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.register.confirmation,
                          expression: "register.confirmation"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: {
                      ...
                      domProps: { value: _vm.register.confirmation },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.register.confirmation = $event.target.value
                        }
                      }
                    })
                  ])
                  ...
                  _c("div", { staticClass: "col-md-6" }, [
                    _c("div", { staticClass: "input-group" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.register.apiToken,
                            expression: "register.apiToken"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: {
                        ...
                        domProps: { value: _vm.register.apiToken },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.register.apiToken = $event.target.value
                          }
                        }
                      }),
                      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-02a54c1b", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3b6ee96c", Component.options)
  } else {
    hotAPI.reload("data-v-3b6ee96c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "active", attrs: { id: "wrapper" } }, [
      _c("div", { attrs: { id: "sidebar-wrapper" } }, [
        _c(
          "ul",
          { staticClass: "sidebar-nav", attrs: { id: "sidebar_menu" } },
          [
            _c("li", { staticClass: "sidebar-brand" }, [
              _c("a", { attrs: { id: "menu-toggle", href: "#" } }, [
                _vm._v("Menu "),
                _c("span", {
        ...
        _vm._v(" "),
        _c("ul", { staticClass: "sidebar-nav", attrs: { id: "sidebar" } }, [
          _c("li", [
            _c("a", [
              _vm._v("Link1 "),
              _c("span", { staticClass: "sub_icon glyphicon glyphicon-link" })
            ])
          ]),
          _vm._v(" "),
          _c("li", [
      ...
      _c("div", { attrs: { id: "page-content-wrapper" } }, [
        _c("div", { staticClass: "page-content inset" }, [
          _c("div", { staticClass: "row" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3b6ee96c", module.exports)
  }
}
